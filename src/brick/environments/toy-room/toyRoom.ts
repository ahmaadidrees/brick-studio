...
/**
 * Brickgineers direction I palette for the room. Brand tokens first, then the
 * derived scene tints (all hand-picked against the warm lamp / cool room split).
 */
export const TOY_ROOM_PALETTE = {
  cornflower: '#5888DA',
  coral: '#F17861',
  butter: '#F3CA74',
  ink: '#263C51',
  warmWhite: '#F8F4EB',
  /** Second, deeper blue for spines and giant bricks. */
  navy: '#3A5FB0',
  green: '#6FB26A',
  /** Cool blue room: walls, fog and the dusk beyond the window. */
  wall: '#4A6DB8',
  wallTrim: '#3A5799',
  fog: '#43619F',
  windowCool: '#A9BFF0',
  /** Warm side: the honey desk and the lamp light. */
  desk: '#CF9A5F',
  deskEdge: '#B8834B',
  deskLeg: '#A5703F',
  lampWarm: '#FFD39C',
...
/** Warm-white studded baseplate, as on every direction I board. */
export const EXPLORE_PLATE_COLOR = '#E9E2D3'
...
/**
 * Wall clock and poster on the back wall, well above the lamp and clear of the
 * window so neither competes with the desk. The clock is decoration only: its
...
export const TOY_PROPS: readonly ToyProp[] = [
  ...
  { id: 'book-0', kind: 'book', x: 45.6, z: -12.9, rotation: 0.052, half: [BOOK_HALF_LENGTH, BOOK_HALF_WIDTH], group: 'books', lift: 0, color: TOY_ROOM_PALETTE.navy },
  { id: 'book-1', kind: 'book', x: 44.3, z: -11.2, rotation: 0.331, half: [12.4, 9], group: 'books', lift: BOOK_THICKNESS, color: TOY_ROOM_PALETTE.coral },
  { id: 'book-2', kind: 'book', x: 45.4, z: -12.4, rotation: 0.14, half: [11.8, 8.6], group: 'books', lift: BOOK_THICKNESS * 2, color: TOY_ROOM_PALETTE.butter },
  { id: 'book-3', kind: 'book', x: BOOK_STACK_X, z: BOOK_STACK_Z, rotation: BOOK_STACK_ROTATION, half: [BOOK_HALF_LENGTH, BOOK_HALF_WIDTH], group: 'books', lift: BOOK_THICKNESS * 3, color: TOY_ROOM_PALETTE.cornflower },
  { id: 'ruler-ramp', kind: 'ruler-ramp', x: ramp.x, z: ramp.z, rotation: ramp.rotation, half: [RAMP_WIDTH / 2, RAMP_LENGTH / 2], group: 'books' },

  { id: 'mug', kind: 'mug', x: 33, z: 33, rotation: -0.44, half: [5.7, 4.3], group: 'pencil-cup' },
  { id: 'coaster', kind: 'coaster', x: 24.5, z: 41, rotation: 0, half: [5.2, 5.2], group: 'pencil-cup' },

  { id: 'pencil', kind: 'pencil', x: -30, z: 40, rotation: 0.14, half: [13.2, 0.7] },

  { id: 'giant-brick-red', kind: 'giant-brick', x: 56, z: 34, rotation: 0.7, half: [3.72, 7.44], color: TOY_ROOM_PALETTE.coral, scale: 6, variant: 'brick_2x4' },
  { id: 'giant-brick-blue', kind: 'giant-brick', x: -54, z: -8, rotation: 1.31, half: [3.72, 7.44], color: TOY_ROOM_PALETTE.cornflower, scale: 6, variant: 'brick_2x4' },
  { id: 'giant-brick-yellow', kind: 'giant-brick', x: 18, z: -40, rotation: 0.35, half: [2.48, 2.48], color: TOY_ROOM_PALETTE.butter, scale: 4, variant: 'brick_2x2' },
  { id: 'giant-brick-green', kind: 'giant-brick', x: -6, z: 44, rotation: -0.52, half: [3.1, 3.1], color: TOY_ROOM_PALETTE.green, scale: 5, variant: 'brick_2x2' },
  { id: 'giant-brick-orange', kind: 'giant-brick', x: 50, z: -38, rotation: 0.96, half: [3.72, 7.44], color: TOY_ROOM_PALETTE.navy, scale: 6, variant: 'brick_2x4' },

  { id: 'eraser', kind: 'eraser', x: 14, z: 36, rotation: 0.44, half: [3, 1.5] },
  { id: 'crayon-a', kind: 'crayon', x: -40, z: -12, rotation: 1.75, half: [5.5, 0.55], color: TOY_ROOM_PALETTE.coral },
  { id: 'crayon-b', kind: 'crayon', x: -38, z: 8, rotation: 1.19, half: [5.5, 0.55], color: TOY_ROOM_PALETTE.cornflower },
  { id: 'crayon-c', kind: 'crayon', x: -34, z: -26, rotation: 0.26, half: [5.5, 0.55], color: TOY_ROOM_PALETTE.green },
...
export function toyRoomFeatures(compactRenderer: boolean, reducedMotion: boolean): ToyRoomFeatures {
  return {
    ...
    dustCount: compactRenderer ? 40 : 110,
