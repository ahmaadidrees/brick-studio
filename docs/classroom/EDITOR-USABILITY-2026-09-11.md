...
- Color changes during group previews apply to the full preview while preserving the original bricks until placement.
...
- Node 22 full check: 760 frontend tests and 64 Worker tests, core/Worker type checks, and production build passed (824 tests total).
