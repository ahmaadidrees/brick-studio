...
2. Move its translucent preview over the 64×64-stud plate and click or tap.
3. Select placed bricks to recolor, rotate, move, copy, duplicate, or delete them.
4. Use right-drag to orbit, Shift-drag to pan, scroll or pinch to zoom, and the view presets to reorient.
