...
await db.close();
console.log('PASS: migration execution, valid CAS, stale CAS, removed membership, revoked session, credential lease, student/world quotas, recovery byte cap, oversized document, anonymous/authenticated table and RPC denial. Concurrency and hosted provider behavior require separate proof.');
