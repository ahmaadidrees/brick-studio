// W7 copy of scripts/qa/verify-expanded-performance.mjs (W8-owned) parameterized by UI_ORIGIN and OUT_DIR.
// Same fixture: one 64x64x192 custom brick on a 128 plate, Explore entered through the real store, RAF p95 +
// renderer counters sampled after spawn. Usage: UI_ORIGIN=http://127.0.0.1:5197 OUT_DIR=... node docs/brand/qa/w7/perf-harness.mjs
...
const origin=process.env.UI_ORIGIN || 'http://127.0.0.1:5197', output=process.env.OUT_DIR || '/tmp/brick-w7-performance'
