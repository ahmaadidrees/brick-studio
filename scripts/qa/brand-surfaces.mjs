...
const SURFACES = [
  ...
  { id: 'world-menu', board: '12', route: '/build', ready: 'worldMenu', steps: [{ click: 'worldMenu' }, { waitFor: 'menuMyWorlds' }], expect: 'studioMenu', escape: true, focusReturnsTo: 'worldMenu' },
  { id: 'settings', board: '12', route: '/build', ready: 'worldMenu', steps: [{ click: 'settings' }], expect: 'settingsDialog', escape: true, focusReturnsTo: 'settings' },
